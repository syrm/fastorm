-- --------------------------------------------------------
-- Hôte:                         a.bouh.org
-- Version du serveur:           5.5.37-1 - (Debian)
...
-- Export de la structure de table world. T_CITY_CIT
...
-- Export de données de la table world.T_CITY_CIT: ~4 051 rows (environ)
/*!40000 ALTER TABLE `T_CITY_CIT` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `T_CITY_CIT` ENABLE KEYS */;


-- Export de la structure de table world. T_COUNTRYLANGUAGE_COL
...
-- Export de données de la table world.T_COUNTRYLANGUAGE_COL: ~1 045 rows (environ)
/*!40000 ALTER TABLE `T_COUNTRYLANGUAGE_COL` DISABLE KEYS */;
INSERT INTO `T_COUNTRYLANGUAGE_COL` (`cou_code`, `col_language`, `col_is_official`, `col_percentage`) VALUES
	...
	('ZWE', 'Nyanja', 'F', 2.2),
	('ZWE', 'Shona', 'F', 72.1);
/*!40000 ALTER TABLE `T_COUNTRYLANGUAGE_COL` ENABLE KEYS */;


-- Export de la structure de table world. T_COUNTRY_COU
...
-- Export de données de la table world.T_COUNTRY_COU: ~245 rows (environ)
/*!40000 ALTER TABLE `T_COUNTRY_COU` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `T_COUNTRY_COU` ENABLE KEYS */;
